...
`;le(ne);q.render=se;const ae={},re=S("span",{class:"material-icons-outlined text-lg align-bottom mr-1","aria-hidden":"true"},"arrow_back",-1),oe=S("span",{class:"text-lg"},"Startseite",-1);function de(e,t){const s=m("router-link");return r(),o(s,{to:"/mitra-frontend/",class:"block mb-4"},{default:h(()=>[re,oe]),_:1})}var fe=M(ae,[["render",de]]);export{fe as N,q as s};
