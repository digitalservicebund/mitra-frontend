...
`;It(Et);ge.render=St;const Lt={class:"flex"},Dt={class:"flex-col"},Mt={class:"flex-col p-8"},Pt=L({setup(e){const t=vt(),n=kt(),l=N.fromPlaybook(t.load()),o="Unbenannter Vertrag",a=C(o),d=C(o),c=C(!1),i=()=>{d.value=a.value,c.value=!0},h=()=>{c.value=!1,a.value=d.value,l.title=d.value},f=k=>{const b=k.target;b==null||b.select()},I=async()=>{await n.save(l)};return $(i),(k,b)=>{const M=j("focus");return s(),P("div",Lt,[_("div",Dt,[u(lt,{modules:v(l).getModules,onSave:I},null,8,["modules"])]),_("div",Mt,[u(v(ge),{id:"dialog-contract-title",visible:c.value,"onUpdate:visible":b[1]||(b[1]=R=>c.value=R),modal:!0,"dismissable-mask":!0,header:"Wie wollen Sie den Vertrag benennen?"},{footer:S(()=>[u(v(A),{label:"OK",icon:"pi pi-check",onClick:h})]),default:S(()=>[D(u(v(U),{id:"input-contract-title",modelValue:d.value,"onUpdate:modelValue":b[0]||(b[0]=R=>d.value=R),title:"Titel des Vertrags",type:"text",onFocus:f,onKeyup:Ce(h,["enter"])},null,8,["modelValue","onKeyup"]),[[M]])]),_:1},8,["visible"]),_("section",null,[u(v(A),{class:"p-button-link",onClick:i},{default:S(()=>[_("span",null,x(a.value),1)]),_:1})]),u(K,{name:"fade",mode:"out-in"},{default:S(()=>[u(Ue,{contract:v(l)},null,8,["contract"])]),_:1})])])}}});var zt=ee(Pt,[["__scopeId","data-v-d1ff55bc"]]);const Kt=L({setup(e){return(t,n)=>(s(),r(zt))}});export{Kt as default};
