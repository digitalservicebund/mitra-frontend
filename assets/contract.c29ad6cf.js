...
`;oe(se);A.render=le;var X={name:"InputText",emits:["update:modelValue"],props:{modelValue:null},methods:{onInput(e){this.$emit("update:modelValue",e.target.value)}},computed:{filled(){return this.modelValue!=null&&this.modelValue.toString().length>0}}};function re(e,t,n,l,o,i){return s(),d("input",P({class:["p-inputtext p-component",{"p-filled":i.filled}],value:n.modelValue,onInput:t[1]||(t[1]=(...r)=>i.onInput&&i.onInput(...r))},e.$attrs),null,16,["value"])}X.render=re;const de=C({setup(e){const t=S("Unbenannter Vertrag"),n=S(),l=S(!1),o=()=>{n.value=t.value,l.value=!0},i=()=>{l.value=!1,t.value=n.value},r=B=>{const u=B.target;u==null||u.select()};H(()=>o());const x=W().findById("test-playbook");return(B,u)=>{const Y=D("focus");return s(),h(y,null,[c(Z),c(b(A),{id:"dialog-contract-title",visible:l.value,"onUpdate:visible":u[1]||(u[1]=L=>l.value=L),modal:!0,"dismissable-mask":!0,header:"Wie wollen Sie den Vertrag benennen?"},{footer:w(()=>[c(b(z),{label:"OK",icon:"pi pi-check",onClick:i})]),default:w(()=>[v(c(b(X),{id:"input-contract-title",modelValue:n.value,"onUpdate:modelValue":u[0]||(u[0]=L=>n.value=L),title:"Titel des Vertrags",type:"text",onFocus:r,onKeyup:R(i,["enter"])},null,8,["modelValue","onKeyup"]),[[Y]])]),_:1},8,["visible"]),f("section",null,[c(b(z),{class:"p-button-link",onClick:o},{default:w(()=>[f("span",null,g(t.value),1)]),_:1})]),c(G,{title:t.value,playbook:b(x)},null,8,["title","playbook"])],64)}}}),ue=C({setup(e){return(t,n)=>(s(),d(de))}});export{ue as default};
