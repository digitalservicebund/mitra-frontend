...
`;ce(me);Y.render=pe;var M={name:"InputText",emits:["update:modelValue"],props:{modelValue:null},methods:{onInput(e){this.$emit("update:modelValue",e.target.value)}},computed:{filled(){return this.modelValue!=null&&this.modelValue.toString().length>0}}};function ue(e,t,n,o,l,i){return r(),p("input",V({class:["p-inputtext p-component",{"p-filled":i.filled}],value:n.modelValue,onInput:t[1]||(t[1]=(...s)=>i.onInput&&i.onInput(...s))},e.$attrs),null,16,["value"])}M.render=ue;const ge=C({setup(e){const t=ee(),n=B.fromPlaybook(t.load()),o="Unbenannter Vertrag",l=z(o),i=z(o),s=z(!1),d=()=>{i.value=l.value,s.value=!0},h=()=>{s.value=!1,l.value=i.value,n.name=i.value},N=P=>{const u=P.target;u==null||u.select()};return F(d),(P,u)=>{const O=E("focus");return r(),f(D,null,[c(q),c(b(Y),{id:"dialog-contract-title",visible:s.value,"onUpdate:visible":u[1]||(u[1]=w=>s.value=w),modal:!0,"dismissable-mask":!0,header:"Wie wollen Sie den Vertrag benennen?"},{footer:k(()=>[c(b(I),{label:"OK",icon:"pi pi-check",onClick:h})]),default:k(()=>[y(c(b(M),{id:"input-contract-title",modelValue:i.value,"onUpdate:modelValue":u[0]||(u[0]=w=>i.value=w),title:"Titel des Vertrags",type:"text",onFocus:N,onKeyup:W(h,["enter"])},null,8,["modelValue","onKeyup"]),[[O]])]),_:1},8,["visible"]),x("section",null,[c(b(I),{class:"p-button-link",onClick:d},{default:k(()=>[x("span",null,g(l.value),1)]),_:1})]),c(J,{contract:b(n)},null,8,["contract"])],64)}}}),ye=C({setup(e){return(t,n)=>(r(),p(ge))}});export{ye as default};
