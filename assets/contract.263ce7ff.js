...
`;kt(wt);ue.render=vt;const _t={class:"flex"},Ct={class:"flex-col"},St={class:"flex-col p-8"},It=A({setup(e){const t=ht(),n=ft(),l=V.fromPlaybook(t.load()),o="Unbenannter Vertrag",i=I(o),d=I(o),u=I(!1),a=()=>{d.value=i.value,u.value=!0},h=()=>{u.value=!1,i.value=d.value,l.title=d.value},f=w=>{const b=w.target;b==null||b.select()},S=async()=>{await n.save(l)};return Q(a),(w,b)=>{const L=R("focus");return s(),j("div",_t,[_("div",Ct,[c($e,{modules:v(l).getModules,onSave:S},null,8,["modules"])]),_("div",St,[c(v(ue),{id:"dialog-contract-title",visible:u.value,modal:!0,"dismissable-mask":!0,header:"Wie wollen Sie den Vertrag benennen?"},{footer:C(()=>[c(v(z),{label:"OK",icon:"pi pi-check",onClick:h})]),default:C(()=>[E(c(v(F),{id:"input-contract-title",modelValue:d.value,"onUpdate:modelValue":b[0]||(b[0]=pe=>d.value=pe),title:"Titel des Vertrags",type:"text",onFocus:f,onKeyup:ve(h,["enter"])},null,8,["modelValue","onKeyup"]),[[L]])]),_:1},8,["visible"]),_("section",null,[c(v(z),{class:"p-button-link",onClick:a},{default:C(()=>[_("span",null,y(i.value),1)]),_:1})]),c(T,{name:"fade",mode:"out-in"},{default:C(()=>[c(je,{contract:v(l)},null,8,["contract"])]),_:1})])])}}});var Lt=$(It,[["__scopeId","data-v-7ea534b4"]]);const zt=A({setup(e){return(t,n)=>(s(),r(Lt))}});export{zt as default};
