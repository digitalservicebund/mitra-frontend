...
`;ne(ie);j.render=te;var K={name:"InputText",emits:["update:modelValue"],props:{modelValue:null},methods:{onInput(e){this.$emit("update:modelValue",e.target.value)}},computed:{filled(){return this.modelValue!=null&&this.modelValue.toString().length>0}}};function ae(e,t,n,s,l,i){return o(),d("input",z({class:["p-inputtext p-component",{"p-filled":i.filled}],value:n.modelValue,onInput:t[1]||(t[1]=(...r)=>i.onInput&&i.onInput(...r))},e.$attrs),null,16,["value"])}K.render=ae;const le=k({setup(e){const t=B(""),n=B(!1),s=()=>{n.value=!0},l=()=>{n.value=!1};N(()=>s());const r=Z().findById("test-playbook");return(p,g)=>(o(),h(b,null,[c(A),c(y(j),{id:"dialog-contract-title",visible:n.value,"onUpdate:visible":g[1]||(g[1]=v=>n.value=v),closable:!1,modal:!0,header:"Wie wollen Sie den Vertrag benennen?"},{footer:D(()=>[c(y(_),{label:"OK",icon:"pi pi-check",onClick:l})]),default:D(()=>[c(y(K),{id:"input-contract-title",modelValue:t.value,"onUpdate:modelValue":g[0]||(g[0]=v=>t.value=v),title:"Titel des Vertrags",type:"text"},null,8,["modelValue"])]),_:1},8,["visible"]),c(O,{title:t.value,playbook:y(r)},null,8,["title","playbook"])],64))}}),de=k({setup(e){return(t,n)=>(o(),d(le))}});export{de as default};
