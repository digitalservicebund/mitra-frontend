...
`;ue(ce);I.render=pe;const he={id:"open-playbook"},fe=m("h2",{class:"font-bold mb-4"},"Neuen Vertrag erstellen",-1),me={for:"upload-playbook"},be=y("W\xE4hlen Sie ein Playbook von Ihrer Festplatte aus. "),ge={class:"mt-4"},ye=m("input",{id:"upload-playbook",type:"file"},null,-1),ve=m("p",null,"Datei in diesen Bereich ziehen.",-1),ke=_({setup(e){const t=N("Computer durchsuchen"),s=O(),a=j(),n=async p=>{const c=await i(p),h=V.fromJson(c);console.log(h),s.save(h),await a.push("/mitra-frontend/contract")},i=async p=>{let c=p==null?void 0:p.files[0];if(c){const h=new FileReader;h.readAsText(c);const g=await new Promise(l=>{h.onload=()=>{l(h.result)}});return JSON.parse(g).playbook}};return(p,c)=>(o(),P(k,null,[d(R),m("section",he,[fe,m("label",me,[be,m("div",ge,[d(A(I),{title:"playbook-hochladen","choose-label":t.value,"show-upload-button":!1,"show-cancel-button":!1,"custom-upload":!0,auto:!0,accept:".json",onUploader:n},{empty:b(()=>[ve]),default:b(()=>[ye]),_:1},8,["choose-label"])])])])],64))}}),Se=_({setup(e){return(t,s)=>(o(),r(ke))}});export{Se as default};
