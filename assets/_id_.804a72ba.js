...
`;ye(fe);U.render=he;var Y={name:"Inplace",emits:["open","close","update:active"],props:{closable:{type:Boolean,default:!1},active:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1}},watch:{active(e){this.d_active=e}},data(){return{d_active:this.active}},methods:{open(e){this.disabled||(this.$emit("open",e),this.d_active=!0,this.$emit("update:active",!0))},close(e){this.$emit("close",e),this.d_active=!1,this.$emit("update:active",!1)}},computed:{containerClass(){return["p-inplace p-component",{"p-inplace-closable":this.closable}]},displayClass(){return["p-inplace-display",{"p-disabled":this.disabled}]}},components:{IPButton:F}};const ve={key:1,class:"p-inplace-content"};function ke(e,t,a,d,c,l){const u=x("IPButton");return s(),i("div",{class:l.containerClass},[c.d_active?(s(),i("div",ve,[D(e.$slots,"content"),a.closable?(s(),i(u,{key:0,icon:"pi pi-times",onClick:l.close},null,8,["onClick"])):m("",!0)])):(s(),i("div",{key:0,class:l.displayClass,tabindex:e.$attrs.tabindex||"0",onClick:t[1]||(t[1]=(...o)=>l.open&&l.open(...o)),onKeydown:t[2]||(t[2]=z((...o)=>l.open&&l.open(...o),["enter"]))},[D(e.$slots,"display")],42,["tabindex"]))],2)}function xe(e,t){t===void 0&&(t={});var a=t.insertAt;if(!(!e||typeof document=="undefined")){var d=document.head||document.getElementsByTagName("head")[0],c=document.createElement("style");c.type="text/css",a==="top"&&d.firstChild?d.insertBefore(c,d.firstChild):d.appendChild(c),c.styleSheet?c.styleSheet.cssText=e:c.appendChild(document.createTextNode(e))}}var _e=`
...
`;Ne(Pe);J.render=Ee;const je=E({props:{playbook:null},emits:["save","navigate"],setup(e,{emit:t}){const a=e,d=q(),c=(o,n)=>n.path.find(p=>p.equals(d.cache.get(a.playbook.id)))?V(B({},o),{class:"font-bold"}):o,l=o=>[{label:"Startseite",icon:"pi pi-angle-left",to:`/mitra-frontend/${d.entryPoint}`},{key:"1",label:a.playbook.title,to:`/mitra-frontend/playbook/${a.playbook.id}`,items:o.map((n,p)=>c({label:`${p+1}. ${n.text}`,command:()=>t("navigate",n.path[0])},n))},{label:"Speichern",icon:"pi pi-fw pi-download",command:()=>t("save")}];d.$subscribe(()=>{u.value=l(a.playbook.modules)});const u=A(l(a.playbook.modules));return(o,n)=>(s(),i(_(J),{model:u.value,"expanded-keys":{"1":!0},class:"w-70"},null,8,["model"]))}});const O=e=>(le("data-v-4aa86ab8"),e=e(),ae(),e),Me={class:"font-bold text-xl"},Ve=O(()=>h("span",{class:"material-icons-outlined text-base","aria-hidden":"true"}," edit ",-1)),ze=se(" \xC4ndern "),De={class:"flex h-full"},He={class:"flex-none"},Le={class:"flex-1 p-8"},Fe=O(()=>h("h2",{class:"font-bold text-lg"},"Module",-1)),qe={open:""},Re={class:"text-lg"},Ue=E({props:{id:null},setup(e){const t=e,a=q(),d=de(),l=ce().findById(t.id),u=A(l.title),o=A(),n={to:`/mitra-frontend/${a.entryPoint}`,label:"Startseite"},p=A([{label:u.value,disabled:!0}]),b=()=>{o.value.open()},v=()=>{l.title=u.value,o.value.close()},C=()=>{d.save(l)},I=g=>{a.rememberCurrentStep(l,g)};return(g,P)=>{const Q=ne("focus");return s(),N(y,null,[h("header",null,[r(_(U),{home:n,model:p.value},null,8,["model"]),r(_(Y),{ref_key:"editTitle",ref:o,closable:!1},{display:k(()=>[h("h1",Me,f(u.value),1)]),content:k(()=>[T(r(_(ie),{modelValue:u.value,"onUpdate:modelValue":P[0]||(P[0]=S=>u.value=S),onKeyup:z(v,["enter"]),onBlur:v},null,8,["modelValue","onKeyup"]),[[Q]])]),_:1},512),r(_(F),{type:"button",onClick:b},{default:k(()=>[Ve,ze]),_:1})]),h("div",De,[h("nav",He,[r(je,{playbook:_(l),onSave:C,onNavigate:I},null,8,["playbook"])]),h("main",Le,[h("section",null,[Fe,h("ol",null,[(s(!0),N(y,null,w(_(l).modules,S=>(s(),N("li",{key:S.id,class:"mt-4 border p-4 shadow-md"},[h("details",qe,[h("summary",Re,f(S.text),1),h("p",null,f(S.steps.length)+" Fragen",1)])]))),128))])])])])],64)}}});var Ye=oe(Ue,[["__scopeId","data-v-4aa86ab8"]]);const $e=E({props:{id:null},setup(e){return(t,a)=>(s(),i(Ye,{id:e.id},null,8,["id"]))}});export{$e as default};
