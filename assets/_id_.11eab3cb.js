...
`;Me(je);q.render=Ve;const Ne={class:"flex"},Fe={class:"flex-col"},Ye={class:"flex-col p-8"},Xe=L({props:{id:null},setup(e){const t=e,a=de(),d=re(),o=t.id==="cloud-contract"?se.fromPlaybook(oe().findById("db2a1d38-01fb-4ea2-bc6f-b5213413c809")):d.findById(t.id);if(o===void 0)throw new Error("Contract not found");const n=o.title||"Unbenannter Vertrag",u=I(n),c=I(n),i=I(!1),p=()=>{c.value=u.value,i.value=!0},g=()=>{i.value=!1,u.value=c.value,o.title=c.value},k=_=>{const f=_.target;f==null||f.select()},w=()=>{a.save(o)};return ne(()=>{o.title||p()}),(_,f)=>{const W=Z("focus");return l(),T("div",Ne,[x("nav",Fe,[r(Ke,{modules:h(o).modules,onSave:w},null,8,["modules"])]),x("main",Ye,[r(h(q),{id:"dialog-contract-title",visible:i.value,"onUpdate:visible":f[1]||(f[1]=K=>i.value=K),modal:!0,"dismissable-mask":!0,header:"Wie wollen Sie den Vertrag benennen?"},{footer:y(()=>[r(h(B),{label:"OK",icon:"pi pi-check",onClick:g})]),default:y(()=>[D(r(h(N),{id:"input-contract-title",modelValue:c.value,"onUpdate:modelValue":f[0]||(f[0]=K=>c.value=K),title:"Titel des Vertrags",type:"text",onFocus:k,onKeyup:ae(g,["enter"])},null,8,["modelValue","onKeyup"]),[[W]])]),_:1},8,["visible"]),x("section",null,[r(h(B),{class:"p-button-link",onClick:p},{default:y(()=>[x("span",null,v(u.value),1)]),_:1})]),r(z,{name:"fade",mode:"out-in"},{default:y(()=>[r(xe,{contract:h(o)},null,8,["contract"])]),_:1})])])}}});var He=j(Xe,[["__scopeId","data-v-dc2f9e1c"]]);const Ge=L({props:{id:null},setup(e){return(t,a)=>(l(),s(He,{id:e.id},null,8,["id"]))}});export{Ge as default};
