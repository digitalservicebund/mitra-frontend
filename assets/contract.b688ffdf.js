var fe=Object.defineProperty;var $=Object.getOwnPropertySymbols;var he=Object.prototype.hasOwnProperty,be=Object.prototype.propertyIsEnumerable;var j=(e,t,n)=>t in e?fe(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,ee=(e,t)=>{for(var n in t||(t={}))he.call(t,n)&&j(e,n,t[n]);if($)for(var n of $(t))be.call(t,n)&&j(e,n,t[n]);return e};var Y=(e,t,n)=>(j(e,typeof t!="symbol"?t+"":t,n),n),xe=(e,t,n)=>{if(!t.has(e))throw TypeError("Cannot "+n)};var te=(e,t,n)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,n)};var H=(e,t,n)=>(xe(e,t,"access private method"),n);import{o as s,c as o,s as ne,m as E,n as L,p as P,q as k,t as w,h as u,u as b,F as I,x as B,y as X,g as m,U,r as K,l as ae,w as _,j as D,v as ie,T as V,z as le,Z as O,D as x,i as se,e as q,A as ye,f as ve,k as ke}from"./vendor.c6f07d2e.js";import{s as M,R as we}from"./button.esm.aade555f.js";import{_ as Z}from"./index.fcf163a1.js";var F,_e=new Uint8Array(16);function Ce(){if(!F&&(F=typeof crypto!="undefined"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)||typeof msCrypto!="undefined"&&typeof msCrypto.getRandomValues=="function"&&msCrypto.getRandomValues.bind(msCrypto),!F))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return F(_e)}var Se=/^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i;function Ie(e){return typeof e=="string"&&Se.test(e)}var g=[];for(var G=0;G<256;++G)g.push((G+256).toString(16).substr(1));function Le(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:0,n=(g[e[t+0]]+g[e[t+1]]+g[e[t+2]]+g[e[t+3]]+"-"+g[e[t+4]]+g[e[t+5]]+"-"+g[e[t+6]]+g[e[t+7]]+"-"+g[e[t+8]]+g[e[t+9]]+"-"+g[e[t+10]]+g[e[t+11]]+g[e[t+12]]+g[e[t+13]]+g[e[t+14]]+g[e[t+15]]).toLowerCase();if(!Ie(n))throw TypeError("Stringified UUID is invalid");return n}function Ee(e,t,n){e=e||{};var l=e.random||(e.rng||Ce)();if(l[6]=l[6]&15|64,l[8]=l[8]&63|128,t){n=n||0;for(var r=0;r<16;++r)t[n+r]=l[r];return t}return Le(l)}const De=e=>e instanceof z;class z{constructor(){Y(this,"id");this.id=Ee()}equals(t){return t==null?!1:this===t?!0:De(t)?this.id===t.id:!1}}var T,oe;const Q=class extends z{constructor(t,n){super();te(this,T);this.title=t,this.modules=n}static fromPlaybook(t){const n=t.modules.map(l=>l.clone());return new Q("",n)}getSteps(){return this.modules.flatMap(t=>t.steps)}getNextStepFor(t){return this.getSteps()[H(this,T,oe).call(this,t)+1]}getPreviousStepFor(t){return this.getSteps()[H(this,T,oe).call(this,t)-1]}getModules(){return this.modules}getModuleFor(t){return this.modules.find(n=>n.steps.find(l=>l.equals(t)))}};let W=Q;T=new WeakSet,oe=function(t){return this.getSteps().findIndex(n=>n.equals(t))};class ze{}class Ae extends ze{constructor(t=""){super();this.answer=t}getAnswer(){return this.answer}setAnswer(t){this.answer=t}toString(){return this.answer}}class Te extends z{constructor(t,n){super();this.text=t,this.answer=n}getAnswer(){return this.answer}setAnswer(t){this.answer.setAnswer(t)}isUnanswered(){return!this.answer.getAnswer()}}const N=class extends Te{constructor(t,n=new Ae){super(t,n)}getType(){return N.TYPE}clone(){return new N(this.text,this.answer)}};let y=N;Y(y,"TYPE","TextAnswerStep");var J={name:"InputText",emits:["update:modelValue"],props:{modelValue:null},methods:{onInput(e){this.$emit("update:modelValue",e.target.value)}},computed:{filled(){return this.modelValue!=null&&this.modelValue.toString().length>0}}};function Pe(e,t,n,l,r,a){return s(),o("input",ne({class:["p-inputtext p-component",{"p-filled":a.filled}],value:n.modelValue,onInput:t[1]||(t[1]=(...d)=>a.onInput&&a.onInput(...d))},e.$attrs),null,16,["value"])}J.render=Pe;const Be={class:"mb-4"},Ke={class:"mb-4"},Ve=E({props:{step:null},emits:["answerChanged"],setup(e,{emit:t}){const l=L(e.step.getAnswer().toString());return(r,a)=>(s(),P(I,null,[k("div",Be,w(e.step.text),1),k("div",Ke,[u(b(J),{modelValue:l.value,"onUpdate:modelValue":a[0]||(a[0]=d=>l.value=d),title:e.step.text,class:"w-full",type:"text",onInput:a[1]||(a[1]=d=>t("answerChanged",l.value))},null,8,["modelValue","title"])])],64))}});const Me={class:"font-bold"},Fe={class:"w-[30vw]"},Ne={class:"grid grid-cols-3 col-span-full"},Re=E({props:{contract:null},setup(e){const t=e,n=L(t.contract.getSteps()[0]),l=B(()=>n.value===void 0?null:n.value.getType()===y.TYPE?Ve:null),r=B(()=>t.contract.getPreviousStepFor(n.value)!==void 0),a=B(()=>t.contract.getNextStepFor(n.value)!==void 0),d=B(()=>t.contract.getModuleFor(n.value)),c=()=>{const p=t.contract.getPreviousStepFor(n.value);p&&(n.value=p)},i=()=>{const p=t.contract.getNextStepFor(n.value);p&&(n.value=p)};return(p,f)=>{var C,v;return s(),P("section",{key:(C=n.value)==null?void 0:C.id},[k("h3",Me,w((v=b(d))==null?void 0:v.text),1),k("div",Fe,[(s(),o(X(b(l)),{step:n.value,onAnswerChanged:f[0]||(f[0]=h=>{var S;return(S=n.value)==null?void 0:S.setAnswer(h)})},null,8,["step"])),k("div",Ne,[b(r)?(s(),o(b(M),{key:0,label:"Zur\xFCck",class:"p-button-outlined col-start-1",onClick:c})):m("",!0),b(a)?(s(),o(b(M),{key:1,label:"Weiter",class:"p-button-outlined col-start-3",onClick:i})):m("",!0)])])])}}});var je=Z(Re,[["__scopeId","data-v-65face84"]]),re={name:"PanelMenuSub",emits:["item-toggle"],props:{model:{type:null,default:null},template:{type:Function,default:null},expandedKeys:{type:null,default:null},exact:{type:Boolean,default:!0}},data(){return{activeItem:null}},methods:{onItemClick(e,t,n){if(this.isActive(t)&&this.activeItem===null&&(this.activeItem=t),this.disabled(t)){e.preventDefault();return}t.command&&t.command({originalEvent:e,item:t}),this.activeItem&&this.activeItem===t?this.activeItem=null:this.activeItem=t,this.$emit("item-toggle",{item:t,expanded:this.activeItem!=null}),t.to&&n&&n(e)},getItemClass(e){return["p-menuitem",e.className]},linkClass(e,t){return["p-menuitem-link",{"p-disabled":this.disabled(e),"router-link-active":t&&t.isActive,"router-link-active-exact":this.exact&&t&&t.isExactActive}]},isActive(e){return this.expandedKeys?this.expandedKeys[e.key]:e===this.activeItem},getSubmenuIcon(e){const t=this.isActive(e);return["p-panelmenu-icon pi pi-fw",{"pi-angle-right":!t,"pi-angle-down":t}]},visible(e){return typeof e.visible=="function"?e.visible():e.visible!==!1},disabled(e){return typeof e.disabled=="function"?e.disabled():e.disabled},label(e){return typeof e.label=="function"?e.label():e.label}}};const Ye={class:"p-submenu-list",role:"tree"},He={class:"p-menuitem-text"},Xe={class:"p-menuitem-text"},Ue={class:"p-toggleable-content"};function Oe(e,t,n,l,r,a){const d=K("router-link"),c=K("PanelMenuSub",!0);return s(),o("ul",Ye,[(s(!0),o(I,null,ae(n.model,(i,p)=>(s(),o(I,{key:a.label(i)+p.toString()},[a.visible(i)&&!i.separator?(s(),o("li",{key:0,role:"none",class:a.getItemClass(i),style:i.style},[n.template?(s(),o(X(n.template),{key:1,item:i},null,8,["item"])):(s(),o(I,{key:0},[i.to&&!a.disabled(i)?(s(),o(d,{key:0,to:i.to,custom:""},{default:_(({navigate:f,href:C,isActive:v,isExactActive:h})=>[u("a",{href:C,class:a.linkClass(i,{isRouterActive:v,isExactActive:h}),onClick:S=>a.onItemClick(S,i,f),role:"treeitem","aria-expanded":a.isActive(i)},[u("span",{class:["p-menuitem-icon",i.icon]},null,2),u("span",He,w(a.label(i)),1)],10,["href","onClick","aria-expanded"])]),_:2},1032,["to"])):(s(),o("a",{key:1,href:i.url,class:a.linkClass(i),target:i.target,onClick:f=>a.onItemClick(f,i),role:"treeitem","aria-expanded":a.isActive(i),tabindex:a.disabled(i)?null:"0"},[i.items?(s(),o("span",{key:0,class:a.getSubmenuIcon(i)},null,2)):m("",!0),u("span",{class:["p-menuitem-icon",i.icon]},null,2),u("span",Xe,w(a.label(i)),1)],10,["href","target","onClick","aria-expanded","tabindex"]))],64)),u(V,{name:"p-toggleable-content"},{default:_(()=>[D(u("div",Ue,[a.visible(i)&&i.items?(s(),o(c,{model:i.items,key:a.label(i)+"_sub_",template:n.template,expandedKeys:n.expandedKeys,onItemToggle:t[1]||(t[1]=f=>e.$emit("item-toggle",f)),exact:n.exact},null,8,["model","template","expandedKeys","exact"])):m("",!0)],512),[[ie,a.isActive(i)]])]),_:2},1024)],6)):m("",!0),a.visible(i)&&i.separator?(s(),o("li",{class:["p-menu-separator",i.class],style:i.style,key:"separator"+p.toString()},null,6)):m("",!0)],64))),128))])}re.render=Oe;var de={name:"PanelMenu",emits:["update:expandedKeys"],props:{model:{type:Array,default:null},expandedKeys:{type:null,default:null},exact:{type:Boolean,default:!0}},data(){return{activeItem:null}},methods:{onItemClick(e,t,n){if(this.isActive(t)&&this.activeItem===null&&(this.activeItem=t),this.disabled(t)){e.preventDefault();return}t.command&&t.command({originalEvent:e,item:t}),this.activeItem&&this.activeItem===t?this.activeItem=null:this.activeItem=t,this.updateExpandedKeys({item:t,expanded:this.activeItem!=null}),t.to&&n&&n(e)},updateExpandedKeys(e){if(this.expandedKeys){let t=e.item,n=ee({},this.expandedKeys);e.expanded?n[t.key]=!0:delete n[t.key],this.$emit("update:expandedKeys",n)}},getPanelClass(e){return["p-panelmenu-panel",e.class]},getPanelToggleIcon(e){const t=this.isActive(e);return["p-panelmenu-icon pi",{"pi-chevron-right":!t," pi-chevron-down":t}]},getPanelIcon(e){return["p-menuitem-icon",e.icon]},getHeaderLinkClass(e,t){return["p-panelmenu-header-link",{"router-link-active":t&&t.isActive,"router-link-active-exact":this.exact&&t&&t.isExactActive}]},isActive(e){return this.expandedKeys?this.expandedKeys[e.key]:e===this.activeItem},getHeaderClass(e){return["p-component p-panelmenu-header",{"p-highlight":this.isActive(e),"p-disabled":this.disabled(e)}]},visible(e){return typeof e.visible=="function"?e.visible():e.visible!==!1},disabled(e){return typeof e.disabled=="function"?e.disabled():e.disabled},label(e){return typeof e.label=="function"?e.label():e.label}},components:{PanelMenuSub:re},computed:{ariaId(){return U()}}};const qe={class:"p-panelmenu p-component"},Ze={class:"p-menuitem-text"},Ge={class:"p-menuitem-text"},We={key:0,class:"p-panelmenu-content"};function Je(e,t,n,l,r,a){const d=K("router-link"),c=K("PanelMenuSub");return s(),o("div",qe,[(s(!0),o(I,null,ae(n.model,(i,p)=>(s(),o(I,{key:a.label(i)+"_"+p},[a.visible(i)?(s(),o("div",{key:0,class:a.getPanelClass(i),style:i.style},[u("div",{class:a.getHeaderClass(i),style:i.style},[e.$slots.item?(s(),o(X(e.$slots.item),{key:1,item:i},null,8,["item"])):(s(),o(I,{key:0},[i.to&&!a.disabled(i)?(s(),o(d,{key:0,to:i.to,custom:""},{default:_(({navigate:f,href:C,isActive:v,isExactActive:h})=>[u("a",{href:C,class:a.getHeaderLinkClass(i,{isActive:v,isExactActive:h}),onClick:S=>a.onItemClick(S,i,f),role:"treeitem"},[i.icon?(s(),o("span",{key:0,class:a.getPanelIcon(i)},null,2)):m("",!0),u("span",Ze,w(a.label(i)),1)],10,["href","onClick"])]),_:2},1032,["to"])):(s(),o("a",{key:1,href:i.url,class:a.getHeaderLinkClass(i),onClick:f=>a.onItemClick(f,i),tabindex:a.disabled(i)?null:"0","aria-expanded":a.isActive(i),id:a.ariaId+"_header","aria-controls":a.ariaId+"_content"},[i.items?(s(),o("span",{key:0,class:a.getPanelToggleIcon(i)},null,2)):m("",!0),i.icon?(s(),o("span",{key:1,class:a.getPanelIcon(i)},null,2)):m("",!0),u("span",Ge,w(a.label(i)),1)],10,["href","onClick","tabindex","aria-expanded","id","aria-controls"]))],64))],6),u(V,{name:"p-toggleable-content"},{default:_(()=>[D(u("div",{class:"p-toggleable-content",role:"region",id:a.ariaId+"_content","aria-labelledby":a.ariaId+"_header"},[i.items?(s(),o("div",We,[u(c,{model:i.items,class:"p-panelmenu-root-submenu",template:e.$slots.item,expandedKeys:n.expandedKeys,onItemToggle:a.updateExpandedKeys,exact:n.exact},null,8,["model","template","expandedKeys","onItemToggle","exact"])])):m("",!0)],8,["id","aria-labelledby"]),[[ie,a.isActive(i)]])]),_:2},1024)],6)):m("",!0)],64))),128))])}function Qe(e,t){t===void 0&&(t={});var n=t.insertAt;if(!(!e||typeof document=="undefined")){var l=document.head||document.getElementsByTagName("head")[0],r=document.createElement("style");r.type="text/css",n==="top"&&l.firstChild?l.insertBefore(r,l.firstChild):l.appendChild(r),r.styleSheet?r.styleSheet.cssText=e:r.appendChild(document.createTextNode(e))}}var $e=`
