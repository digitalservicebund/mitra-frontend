var $=Object.defineProperty;var X=Object.getOwnPropertySymbols;var ee=Object.prototype.hasOwnProperty,te=Object.prototype.propertyIsEnumerable;var H=(e,t,a)=>t in e?$(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a,R=(e,t)=>{for(var a in t||(t={}))ee.call(t,a)&&H(e,a,t[a]);if(X)for(var a of X(t))te.call(t,a)&&H(e,a,t[a]);return e};import{o as i,c as s,y as O,i as S,m as D,j as I,k as x,t as b,h as d,u as f,F as k,z,A as V,g as m,B as ne,x as B,U as M,r as K,w,q as E,v as Z,T as A,Z as j,D as h,p as U,f as N,C as ae,l as le,E as ie,s as se}from"./vendor.fc9ea11c.js";import{T as oe,s as T,R as re,C as de,c as ce,a as ue,m as pe}from"./provide.c4d6f8d5.js";import{_ as Y}from"./index.eb6ac8d3.js";var F={name:"InputText",emits:["update:modelValue"],props:{modelValue:null},methods:{onInput(e){this.$emit("update:modelValue",e.target.value)}},computed:{filled(){return this.modelValue!=null&&this.modelValue.toString().length>0}}};function me(e,t,a,c,o,n){return i(),s("input",O({class:["p-inputtext p-component",{"p-filled":n.filled}],value:a.modelValue,onInput:t[1]||(t[1]=(...r)=>n.onInput&&n.onInput(...r))},e.$attrs),null,16,["value"])}F.render=me;const ge={class:"mb-4"},fe={class:"mb-4"},he=S({props:{step:null},emits:["answerChanged"],setup(e,{emit:t}){const c=D(e.step.answer.toString());return(o,n)=>(i(),I(k,null,[x("div",ge,b(e.step.text),1),x("div",fe,[d(f(F),{modelValue:c.value,"onUpdate:modelValue":n[0]||(n[0]=r=>c.value=r),title:e.step.text,class:"w-full",type:"text",onInput:n[1]||(n[1]=r=>t("answerChanged",c.value))},null,8,["modelValue","title"])])],64))}});const be={class:"font-bold"},xe={class:"grid grid-cols-3 col-span-full"},ve=S({props:{contract:null},setup(e){const t=e,a=D(t.contract.getAllSteps()[0]),c=z(()=>a.value.type===oe.TYPE?he:null),o=z(()=>t.contract.getPreviousStepFor(a.value)!==void 0),n=z(()=>t.contract.getNextStepFor(a.value)!==void 0),r=z(()=>t.contract.getModuleFor(a.value)),u=()=>{const p=t.contract.getPreviousStepFor(a.value);p&&(a.value=p)},l=()=>{const p=t.contract.getNextStepFor(a.value);p&&(a.value=p)};return(p,g)=>{var v,_;return i(),I("section",{key:(v=a.value)==null?void 0:v.id},[x("h3",be,b((_=f(r))==null?void 0:_.text),1),(i(),s(V(f(c)),{step:a.value,onAnswerChanged:g[0]||(g[0]=L=>{var y;return(y=a.value)==null?void 0:y.setAnswer(L)})},null,8,["step"])),x("div",xe,[f(o)?(i(),s(f(T),{key:0,label:"Zur\xFCck",class:"p-button-outlined col-start-1",onClick:u})):m("",!0),f(n)?(i(),s(f(T),{key:1,label:"Weiter",class:"p-button-outlined col-start-3",onClick:l})):m("",!0)])])}}});var ye=Y(ve,[["__scopeId","data-v-0d97953a"]]);const ke={},G=ne("session",{state:()=>ke}),we=x("h3",{class:"p-2 font-bold bg-white"},"Vorschau Vertragstext",-1),_e={class:"font-bold"},Ce=S({setup(e){const a=G().lastWorkedOnContract;return(c,o)=>{var n;return i(),I("section",null,[we,(i(!0),I(k,null,B((n=f(a))==null?void 0:n.modules,r=>(i(),I("article",{key:r.id,class:"p-2"},[x("h4",_e,b(r.text),1),(i(!0),I(k,null,B(r.steps,u=>(i(),I("div",{key:u.id,class:"mt-2"},b(u.answer.toString()),1))),128))]))),128))])}}});var W={name:"PanelMenuSub",emits:["item-toggle"],props:{model:{type:null,default:null},template:{type:Function,default:null},expandedKeys:{type:null,default:null},exact:{type:Boolean,default:!0}},data(){return{activeItem:null}},methods:{onItemClick(e,t,a){if(this.isActive(t)&&this.activeItem===null&&(this.activeItem=t),this.disabled(t)){e.preventDefault();return}t.command&&t.command({originalEvent:e,item:t}),this.activeItem&&this.activeItem===t?this.activeItem=null:this.activeItem=t,this.$emit("item-toggle",{item:t,expanded:this.activeItem!=null}),t.to&&a&&a(e)},getItemClass(e){return["p-menuitem",e.className]},linkClass(e,t){return["p-menuitem-link",{"p-disabled":this.disabled(e),"router-link-active":t&&t.isActive,"router-link-active-exact":this.exact&&t&&t.isExactActive}]},isActive(e){return this.expandedKeys?this.expandedKeys[e.key]:e===this.activeItem},getSubmenuIcon(e){const t=this.isActive(e);return["p-panelmenu-icon pi pi-fw",{"pi-angle-right":!t,"pi-angle-down":t}]},visible(e){return typeof e.visible=="function"?e.visible():e.visible!==!1},disabled(e){return typeof e.disabled=="function"?e.disabled():e.disabled},label(e){return typeof e.label=="function"?e.label():e.label}}};const Ie={class:"p-submenu-list",role:"tree"},Le={class:"p-menuitem-text"},Se={class:"p-menuitem-text"},De={class:"p-toggleable-content"};function Ee(e,t,a,c,o,n){const r=K("router-link"),u=K("PanelMenuSub",!0);return i(),s("ul",Ie,[(i(!0),s(k,null,B(a.model,(l,p)=>(i(),s(k,{key:n.label(l)+p.toString()},[n.visible(l)&&!l.separator?(i(),s("li",{key:0,role:"none",class:n.getItemClass(l),style:l.style},[a.template?(i(),s(V(a.template),{key:1,item:l},null,8,["item"])):(i(),s(k,{key:0},[l.to&&!n.disabled(l)?(i(),s(r,{key:0,to:l.to,custom:""},{default:w(({navigate:g,href:v,isActive:_,isExactActive:L})=>[d("a",{href:v,class:n.linkClass(l,{isRouterActive:_,isExactActive:L}),onClick:y=>n.onItemClick(y,l,g),role:"treeitem","aria-expanded":n.isActive(l)},[d("span",{class:["p-menuitem-icon",l.icon]},null,2),d("span",Le,b(n.label(l)),1)],10,["href","onClick","aria-expanded"])]),_:2},1032,["to"])):(i(),s("a",{key:1,href:l.url,class:n.linkClass(l),target:l.target,onClick:g=>n.onItemClick(g,l),role:"treeitem","aria-expanded":n.isActive(l),tabindex:n.disabled(l)?null:"0"},[l.items?(i(),s("span",{key:0,class:n.getSubmenuIcon(l)},null,2)):m("",!0),d("span",{class:["p-menuitem-icon",l.icon]},null,2),d("span",Se,b(n.label(l)),1)],10,["href","target","onClick","aria-expanded","tabindex"]))],64)),d(A,{name:"p-toggleable-content"},{default:w(()=>[E(d("div",De,[n.visible(l)&&l.items?(i(),s(u,{model:l.items,key:n.label(l)+"_sub_",template:a.template,expandedKeys:a.expandedKeys,onItemToggle:t[1]||(t[1]=g=>e.$emit("item-toggle",g)),exact:a.exact},null,8,["model","template","expandedKeys","exact"])):m("",!0)],512),[[Z,n.isActive(l)]])]),_:2},1024)],6)):m("",!0),n.visible(l)&&l.separator?(i(),s("li",{class:["p-menu-separator",l.class],style:l.style,key:"separator"+p.toString()},null,6)):m("",!0)],64))),128))])}W.render=Ee;var q={name:"PanelMenu",emits:["update:expandedKeys"],props:{model:{type:Array,default:null},expandedKeys:{type:null,default:null},exact:{type:Boolean,default:!0}},data(){return{activeItem:null}},methods:{onItemClick(e,t,a){if(this.isActive(t)&&this.activeItem===null&&(this.activeItem=t),this.disabled(t)){e.preventDefault();return}t.command&&t.command({originalEvent:e,item:t}),this.activeItem&&this.activeItem===t?this.activeItem=null:this.activeItem=t,this.updateExpandedKeys({item:t,expanded:this.activeItem!=null}),t.to&&a&&a(e)},updateExpandedKeys(e){if(this.expandedKeys){let t=e.item,a=R({},this.expandedKeys);e.expanded?a[t.key]=!0:delete a[t.key],this.$emit("update:expandedKeys",a)}},getPanelClass(e){return["p-panelmenu-panel",e.class]},getPanelToggleIcon(e){const t=this.isActive(e);return["p-panelmenu-icon pi",{"pi-chevron-right":!t," pi-chevron-down":t}]},getPanelIcon(e){return["p-menuitem-icon",e.icon]},getHeaderLinkClass(e,t){return["p-panelmenu-header-link",{"router-link-active":t&&t.isActive,"router-link-active-exact":this.exact&&t&&t.isExactActive}]},isActive(e){return this.expandedKeys?this.expandedKeys[e.key]:e===this.activeItem},getHeaderClass(e){return["p-component p-panelmenu-header",{"p-highlight":this.isActive(e),"p-disabled":this.disabled(e)}]},visible(e){return typeof e.visible=="function"?e.visible():e.visible!==!1},disabled(e){return typeof e.disabled=="function"?e.disabled():e.disabled},label(e){return typeof e.label=="function"?e.label():e.label}},components:{PanelMenuSub:W},computed:{ariaId(){return M()}}};const ze={class:"p-panelmenu p-component"},Be={class:"p-menuitem-text"},Ke={class:"p-menuitem-text"},Ae={key:0,class:"p-panelmenu-content"};function Te(e,t,a,c,o,n){const r=K("router-link"),u=K("PanelMenuSub");return i(),s("div",ze,[(i(!0),s(k,null,B(a.model,(l,p)=>(i(),s(k,{key:n.label(l)+"_"+p},[n.visible(l)?(i(),s("div",{key:0,class:n.getPanelClass(l),style:l.style},[d("div",{class:n.getHeaderClass(l),style:l.style},[e.$slots.item?(i(),s(V(e.$slots.item),{key:1,item:l},null,8,["item"])):(i(),s(k,{key:0},[l.to&&!n.disabled(l)?(i(),s(r,{key:0,to:l.to,custom:""},{default:w(({navigate:g,href:v,isActive:_,isExactActive:L})=>[d("a",{href:v,class:n.getHeaderLinkClass(l,{isActive:_,isExactActive:L}),onClick:y=>n.onItemClick(y,l,g),role:"treeitem"},[l.icon?(i(),s("span",{key:0,class:n.getPanelIcon(l)},null,2)):m("",!0),d("span",Be,b(n.label(l)),1)],10,["href","onClick"])]),_:2},1032,["to"])):(i(),s("a",{key:1,href:l.url,class:n.getHeaderLinkClass(l),onClick:g=>n.onItemClick(g,l),tabindex:n.disabled(l)?null:"0","aria-expanded":n.isActive(l),id:n.ariaId+"_header_"+p,"aria-controls":n.ariaId+"_content_"+p},[l.items?(i(),s("span",{key:0,class:n.getPanelToggleIcon(l)},null,2)):m("",!0),l.icon?(i(),s("span",{key:1,class:n.getPanelIcon(l)},null,2)):m("",!0),d("span",Ke,b(n.label(l)),1)],10,["href","onClick","tabindex","aria-expanded","id","aria-controls"]))],64))],6),d(A,{name:"p-toggleable-content"},{default:w(()=>[E(d("div",{class:"p-toggleable-content",role:"region",id:n.ariaId+"_content_"+p,"aria-labelledby":n.ariaId+"_header_"+p},[l.items?(i(),s("div",Ae,[d(u,{model:l.items,class:"p-panelmenu-root-submenu",template:e.$slots.item,expandedKeys:a.expandedKeys,onItemToggle:n.updateExpandedKeys,exact:a.exact},null,8,["model","template","expandedKeys","onItemToggle","exact"])])):m("",!0)],8,["id","aria-labelledby"]),[[Z,n.isActive(l)]])]),_:2},1024)],6)):m("",!0)],64))),128))])}function Pe(e,t){t===void 0&&(t={});var a=t.insertAt;if(!(!e||typeof document=="undefined")){var c=document.head||document.getElementsByTagName("head")[0],o=document.createElement("style");o.type="text/css",a==="top"&&c.firstChild?c.insertBefore(o,c.firstChild):c.appendChild(o),o.styleSheet?o.styleSheet.cssText=e:o.appendChild(document.createTextNode(e))}}var Ve=`
...
`;He(Re);J.render=Xe;const Oe={class:"flex h-full"},Ze={class:"flex-none"},Ue={class:"flex-1 p-8"},Ge=S({props:{id:null},setup(e){const t=e,a=G(),c=pe(),o=ue(),n=t.id==="cloud-contract"?de.fromPlaybook(ce().findById("db2a1d38-01fb-4ea2-bc6f-b5213413c809")):o.findById(t.id);a.lastWorkedOnContract=n;const r=n.title||"Unbenannter Vertrag",u=D(r),l=D(r),p=D(!1),g=()=>{l.value=u.value,p.value=!0},v=()=>{p.value=!1,l.value!==r&&(u.value=l.value,n.title=l.value)},_=y=>{const C=y.target;C==null||C.select()},L=()=>{c.save(n)};return ie(()=>{n.title||g()}),(y,C)=>{const Q=U("focus");return i(),I("div",Oe,[x("nav",Ze,[d(je,{modules:f(n).modules,onSave:L},null,8,["modules"])]),x("main",Ue,[d(f(J),{id:"dialog-contract-title",visible:p.value,"onUpdate:visible":C[1]||(C[1]=P=>p.value=P),modal:!0,"dismissable-mask":!0,header:"Wie wollen Sie den Vertrag benennen?"},{footer:w(()=>[d(f(T),{label:"OK",icon:"pi pi-check",onClick:v})]),default:w(()=>[E(d(f(F),{id:"input-contract-title",modelValue:l.value,"onUpdate:modelValue":C[0]||(C[0]=P=>l.value=P),title:"Titel des Vertrags",type:"text",onFocus:_,onKeyup:se(v,["enter"])},null,8,["modelValue","onKeyup"]),[[Q]])]),_:1},8,["visible"]),x("header",null,[d(f(T),{class:"p-button-link",onClick:g},{default:w(()=>[x("span",null,b(u.value),1)]),_:1})]),d(A,{name:"fade",mode:"out-in"},{default:w(()=>[d(ye,{contract:f(n)},null,8,["contract"])]),_:1})]),d(Ce,{class:"flex-1 bg-slate-100"})])}}});var We=Y(Ge,[["__scopeId","data-v-8eed8116"]]);const et=S({props:{id:null},setup(e){return(t,a)=>(i(),s(We,{id:e.id},null,8,["id"]))}});export{et as default};
