...
`;Tt(zt);ye.render=At;const Pt={class:"flex"},Bt={class:"flex-col"},Kt={class:"flex-col p-8"},Mt=E({setup(e){const t=St(),n=It(),o=Y.fromPlaybook(t.load()),l="Unbenannter Vertrag",i=L(l),d=L(l),u=L(!1),a=()=>{d.value=i.value,u.value=!0},f=()=>{u.value=!1,i.value=d.value,o.title=d.value},x=k=>{const b=k.target;b==null||b.select()},h=async()=>{await n.save(o)};return le(a),(k,b)=>{const S=j("focus");return s(),T("div",Pt,[C("div",Bt,[c(ct,{modules:y(o).getAllModules(),onSave:h},null,8,["modules"])]),C("div",Kt,[c(y(ye),{id:"dialog-contract-title",visible:u.value,"onUpdate:visible":b[1]||(b[1]=A=>u.value=A),modal:!0,"dismissable-mask":!0,header:"Wie wollen Sie den Vertrag benennen?"},{footer:_(()=>[c(y(P),{label:"OK",icon:"pi pi-check",onClick:f})]),default:_(()=>[D(c(y(G),{id:"input-contract-title",modelValue:d.value,"onUpdate:modelValue":b[0]||(b[0]=A=>d.value=A),title:"Titel des Vertrags",type:"text",onFocus:x,onKeyup:_e(f,["enter"])},null,8,["modelValue","onKeyup"]),[[S]])]),_:1},8,["visible"]),C("section",null,[c(y(P),{class:"p-button-link",onClick:a},{default:_(()=>[C("span",null,w(i.value),1)]),_:1})]),c(N,{name:"fade",mode:"out-in"},{default:_(()=>[c(We,{contract:y(o)},null,8,["contract"])]),_:1})])])}}});var Vt=X(Mt,[["__scopeId","data-v-00491bde"]]);const Ft=E({setup(e){return(t,n)=>(s(),r(Vt))}});export{Ft as default};
