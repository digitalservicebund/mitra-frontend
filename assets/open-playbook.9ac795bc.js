import{R as B,s as z}from"./button.esm.546feb0e.js";import{o,c as r,e as w,f as y,t as f,g as u,h as d,i as _,w as b,j as v,v as M,T as U,D as C,r as k,k as L,F as x,l as F,m,n as S,p as N,u as j,q as P,s as A}from"./vendor.96cf3c4a.js";import{P as R,m as V}from"./provide.0ed59015.js";import{_ as O}from"./index.c59d67de.js";var D={name:"ProgressBar",props:{value:{type:Number,default:null},mode:{type:String,default:"determinate"},showValue:{type:Boolean,default:!0}},computed:{containerClass(){return["p-progressbar p-component",{"p-progressbar-determinate":this.determinate,"p-progressbar-indeterminate":this.indeterminate}]},progressStyle(){return{width:this.value+"%",display:"flex"}},indeterminate(){return this.mode==="indeterminate"},determinate(){return this.mode==="determinate"}}};const W={key:0,class:"p-progressbar-label"},K={key:1,class:"p-progressbar-indeterminate-container"},H=d("div",{class:"p-progressbar-value p-progressbar-value-animate"},null,-1);function J(e,t,s,a,n,i){return o(),r("div",{role:"progressbar",class:i.containerClass,"aria-valuemin":"0","aria-valuenow":s.value,"aria-valuemax":"100"},[i.determinate?(o(),r("div",{key:0,class:"p-progressbar-value p-progressbar-value-animate",style:i.progressStyle},[s.value!=null&&s.value!==0&&s.showValue?(o(),r("div",W,[w(e.$slots,"default",{},()=>[y(f(s.value+"%"),1)])])):u("",!0)],4)):u("",!0),i.indeterminate?(o(),r("div",K,[H])):u("",!0)],10,["aria-valuenow"])}function q(e,t){t===void 0&&(t={});var s=t.insertAt;if(!(!e||typeof document=="undefined")){var a=document.head||document.getElementsByTagName("head")[0],n=document.createElement("style");n.type="text/css",s==="top"&&a.firstChild?a.insertBefore(n,a.firstChild):a.appendChild(n),n.styleSheet?n.styleSheet.cssText=e:n.appendChild(document.createTextNode(e))}}var G=`
.p-progressbar {
    position: relative;
    overflow: hidden;
}
...
`;q(G);D.render=J;var E={name:"Message",emits:["close"],props:{severity:{type:String,default:"info"},closable:{type:Boolean,default:!0},sticky:{type:Boolean,default:!0},life:{type:Number,default:3e3},icon:{type:String,default:null}},timeout:null,data(){return{visible:!0}},mounted(){this.sticky||setTimeout(()=>{this.visible=!1},this.life)},methods:{close(e){this.visible=!1,this.$emit("close",e)}},computed:{containerClass(){return"p-message p-component p-message-"+this.severity},iconClass(){return["p-message-icon pi",this.icon?this.icon:{"pi-info-circle":this.severity==="info","pi-check":this.severity==="success","pi-exclamation-triangle":this.severity==="warn","pi-times-circle":this.severity==="error"}]}},directives:{ripple:B}};const X={class:"p-message-wrapper"},Y={class:"p-message-text"},Z=d("i",{class:"p-message-close-icon pi pi-times"},null,-1);function Q(e,t,s,a,n,i){const p=_("ripple");return o(),r(U,{name:"p-message",appear:""},{default:b(()=>[v(d("div",{class:i.containerClass,role:"alert"},[d("div",X,[d("span",{class:i.iconClass},null,2),d("div",Y,[w(e.$slots,"default")]),s.closable?v((o(),r("button",{key:0,class:"p-message-close p-link",onClick:t[1]||(t[1]=c=>i.close(c)),type:"button"},[Z],512)),[[p]]):u("",!0)])],2),[[M,n.visible]])]),_:3})}function $(e,t){t===void 0&&(t={});var s=t.insertAt;if(!(!e||typeof document=="undefined")){var a=document.head||document.getElementsByTagName("head")[0],n=document.createElement("style");n.type="text/css",s==="top"&&a.firstChild?a.insertBefore(n,a.firstChild):a.appendChild(n),n.styleSheet?n.styleSheet.cssText=e:n.appendChild(document.createTextNode(e))}}var ee=`
.p-message-wrapper {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
...
`;ue(ce);I.render=pe;const he={},fe=m("span",{class:"pi pi-angle-left text-lg"},"Startseite",-1);function me(e,t){const s=k("router-link");return o(),r(s,{to:"/mitra-frontend/",class:"block mb-4"},{default:b(()=>[fe]),_:1})}var be=O(he,[["render",me]]);const ge={id:"open-playbook"},ye=m("h2",{class:"font-bold mb-4"},"Neuen Vertrag erstellen",-1),ve={for:"upload-playbook"},ke=y("W\xE4hlen Sie ein Playbook von Ihrer Festplatte aus. "),xe={class:"mt-4"},we=m("input",{id:"upload-playbook",type:"file"},null,-1),Ce=m("p",null,"Datei in diesen Bereich ziehen.",-1),Fe=S({setup(e){const t=N("Computer durchsuchen"),s=V(),a=j(),n=async p=>{const c=await i(p),h=R.fromJson(c);s.save(h),await a.push("/mitra-frontend/contract")},i=async p=>{const c=p==null?void 0:p.files[0],h=new FileReader;h.readAsText(c);const g=await new Promise(l=>{h.onload=()=>{l(h.result)}});return JSON.parse(g).playbook};return(p,c)=>(o(),P(x,null,[d(be),m("section",ge,[ye,m("label",ve,[ke,m("div",xe,[d(A(I),{title:"playbook-hochladen","choose-label":t.value,"show-upload-button":!1,"show-cancel-button":!1,"custom-upload":!0,auto:!0,accept:".json",onUploader:n},{empty:b(()=>[Ce]),default:b(()=>[we]),_:1},8,["choose-label"])])])])],64))}}),Ee=S({setup(e){return(t,s)=>(o(),r(Fe))}});export{Ee as default};
