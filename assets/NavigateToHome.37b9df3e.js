...
`;ae(re);J.render=ne;const oe=S("span",{class:"material-icons-outlined text-lg align-bottom mr-1","aria-hidden":"true"},"arrow_back",-1),de=S("span",{class:"text-lg"},"Startseite",-1),fe=T({setup(e){const t=N().entryPoint;return(s,a)=>{const n=h("router-link");return r(),o(n,{to:`/mitra-frontend/${U(t)}`,class:"block mb-4"},{default:f(()=>[oe,de]),_:1},8,["to"])}}});export{fe as _,J as s};
