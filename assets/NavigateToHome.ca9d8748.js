...
`;O(R);D.render=V;var E={name:"Message",emits:["close"],props:{severity:{type:String,default:"info"},closable:{type:Boolean,default:!0},sticky:{type:Boolean,default:!0},life:{type:Number,default:3e3},icon:{type:String,default:null}},timeout:null,data(){return{visible:!0}},mounted(){this.sticky||setTimeout(()=>{this.visible=!1},this.life)},methods:{close(e){this.visible=!1,this.$emit("close",e)}},computed:{containerClass(){return"p-message p-component p-message-"+this.severity},iconClass(){return["p-message-icon pi",this.icon?this.icon:{"pi-info-circle":this.severity==="info","pi-check":this.severity==="success","pi-exclamation-triangle":this.severity==="warn","pi-times-circle":this.severity==="error"}]}},directives:{ripple:F}};const K={class:"p-message-wrapper"},W={class:"p-message-text"},H=d("i",{class:"p-message-close-icon pi pi-times"},null,-1);function q(e,t,s,a,n,i){const c=B("ripple");return r(),o(M,{name:"p-message",appear:""},{default:h(()=>[f(d("div",{class:i.containerClass,role:"alert"},[d("div",K,[d("span",{class:i.iconClass},null,2),d("div",W,[b(e.$slots,"default")]),s.closable?f((r(),o("button",{key:0,class:"p-message-close p-link",onClick:t[1]||(t[1]=g=>i.close(g)),type:"button"},[H],512)),[[c]]):p("",!0)])],2),[[z,n.visible]])]),_:3})}function G(e,t){t===void 0&&(t={});var s=t.insertAt;if(!(!e||typeof document=="undefined")){var a=document.head||document.getElementsByTagName("head")[0],n=document.createElement("style");n.type="text/css",s==="top"&&a.firstChild?a.insertBefore(n,a.firstChild):a.appendChild(n),n.styleSheet?n.styleSheet.cssText=e:n.appendChild(document.createTextNode(e))}}var J=`
.p-message-wrapper {
    display: -webkit-box;
    display: -ms-flexbox;
    display: flex;
...
`;ae(re);Q.render=ne;const oe=S("span",{class:"material-icons-outlined text-lg align-bottom mr-1","aria-hidden":"true"},"arrow_back",-1),de=S("span",{class:"text-lg"},"Startseite",-1),fe=T({setup(e){const t=N().entryPoint;return(s,a)=>{const n=m("router-link");return r(),o(n,{to:`/mitra-frontend/${U(t)}`,class:"block mb-4"},{default:h(()=>[oe,de]),_:1},8,["to"])}}});export{fe as _,Q as s};
