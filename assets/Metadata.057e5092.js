...
`;M(P);K.render=q;var Y={name:"InputText",emits:["update:modelValue"],props:{modelValue:null},methods:{onInput(e){this.$emit("update:modelValue",e.target.value)}},computed:{filled(){return this.modelValue!=null&&this.modelValue.toString().length>0}}};function Z(e,n,t,c,i,l){return a(),s("input",A({class:["p-inputtext p-component",{"p-filled":l.filled}],value:t.modelValue,onInput:n[1]||(n[1]=(...r)=>l.onInput&&l.onInput(...r))},e.$attrs),null,16,["value"])}Y.render=Z;const G=h("dt",null,"Datei erstellt am",-1),H=["datetime"],J={key:1},Q=h("dt",null,"Zuletzt gespeichert am",-1),R=["datetime"],U={key:1},ee=S({props:{createdAt:null,savedAt:null},setup(e){const n="de-DE",t={day:"2-digit",month:"2-digit",year:"numeric"};return(c,i)=>(a(),m("dl",null,[G,h("dd",null,[e.createdAt?(a(),m("time",{key:0,datetime:e.createdAt.toISOString()},p(e.createdAt.toLocaleDateString(n,t)),9,H)):(a(),m("span",J,"-"))]),Q,h("dd",null,[e.savedAt?(a(),m("time",{key:0,datetime:e.savedAt.toISOString()},p(e.savedAt.toLocaleDateString(n,t)),9,R)):(a(),m("span",U,"-"))])]))}});export{ee as _,D as a,K as b,Y as s};
