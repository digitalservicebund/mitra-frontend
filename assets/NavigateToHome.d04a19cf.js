...
`;le(ne);G.render=se;const ae={},re=z("span",{class:"pi pi-angle-left text-lg"},"Startseite",-1);function oe(e,t){const s=m("router-link");return r(),o(s,{to:"/mitra-frontend/",class:"block mb-4"},{default:h(()=>[re]),_:1})}var he=M(ae,[["render",oe]]);export{he as N,G as s};
