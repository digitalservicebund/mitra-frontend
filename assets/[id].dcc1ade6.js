...
`;Pe(Ve);W.render=Be;const Me={class:"flex"},je={class:"flex-col"},Ne={class:"flex-col p-8"},Fe=L({props:{id:null},setup(e){const t=e,l=se(),o=ie().load(t.id),n=o.title?o.title:"Unbenannter Vertrag",d=I(n),r=I(n),a=I(!1),p=()=>{r.value=d.value,a.value=!0},g=()=>{a.value=!1,d.value=r.value,o.title=r.value},k=_=>{const f=_.target;f==null||f.select()},w=async()=>{await l.save(o)};return Z(()=>{o.title||p()}),(_,f)=>{const J=U("focus");return i(),D("div",Me,[x("div",je,[c(ze,{modules:h(o).getModules(),onSave:w},null,8,["modules"])]),x("div",Ne,[c(h(W),{id:"dialog-contract-title",visible:a.value,"onUpdate:visible":f[1]||(f[1]=T=>a.value=T),modal:!0,"dismissable-mask":!0,header:"Wie wollen Sie den Vertrag benennen?"},{footer:y(()=>[c(h(K),{label:"OK",icon:"pi pi-check",onClick:g})]),default:y(()=>[S(c(h(N),{id:"input-contract-title",modelValue:r.value,"onUpdate:modelValue":f[0]||(f[0]=T=>r.value=T),title:"Titel des Vertrags",type:"text",onFocus:k,onKeyup:ae(g,["enter"])},null,8,["modelValue","onKeyup"]),[[J]])]),_:1},8,["visible"]),x("section",null,[c(h(K),{class:"p-button-link",onClick:p},{default:y(()=>[x("span",null,v(d.value),1)]),_:1})]),c(A,{name:"fade",mode:"out-in"},{default:y(()=>[c(he,{contract:h(o)},null,8,["contract"])]),_:1})])])}}});var Ye=j(Fe,[["__scopeId","data-v-38c50dfe"]]);const Ze=L({props:{id:null},setup(e){return(t,l)=>(i(),s(Ye,{id:e.id},null,8,["id"]))}});export{Ze as default};
