...
`;It(Lt);ge.render=St;const Et={class:"flex"},Dt={class:"flex-col"},Mt={class:"flex-col p-8"},zt=E({setup(e){const t=vt(),n=kt(),l=N.fromPlaybook(t.load()),o="Unbenannter Vertrag",a=C(o),d=C(o),c=C(!1),i=()=>{d.value=a.value,c.value=!0},h=()=>{c.value=!1,a.value=d.value,l.title=d.value},f=w=>{const b=w.target;b==null||b.select()},I=async()=>{await n.save(l)};return $(i),(w,b)=>{const M=H("focus");return s(),z("div",Et,[_("div",Dt,[u(lt,{modules:k(l).getModules,onSave:I},null,8,["modules"])]),_("div",Mt,[u(k(ge),{id:"dialog-contract-title",visible:c.value,"onUpdate:visible":b[1]||(b[1]=R=>c.value=R),modal:!0,"dismissable-mask":!0,header:"Wie wollen Sie den Vertrag benennen?"},{footer:S(()=>[u(k(A),{label:"OK",icon:"pi pi-check",onClick:h})]),default:S(()=>[D(u(k(U),{id:"input-contract-title",modelValue:d.value,"onUpdate:modelValue":b[0]||(b[0]=R=>d.value=R),title:"Titel des Vertrags",type:"text",onFocus:f,onKeyup:Ce(h,["enter"])},null,8,["modelValue","onKeyup"]),[[M]])]),_:1},8,["visible"]),_("section",null,[u(k(A),{class:"p-button-link",onClick:i},{default:S(()=>[_("span",null,y(a.value),1)]),_:1})]),u(K,{name:"fade",mode:"out-in"},{default:S(()=>[u(Ue,{contract:k(l)},null,8,["contract"])]),_:1})])])}}});var Pt=ee(zt,[["__scopeId","data-v-d1ff55bc"]]);const Kt=E({setup(e){return(t,n)=>(s(),r(Pt))}});export{Kt as default};
