...
`;Pe(Ve);q.render=Ae;const Me={class:"flex"},je={class:"flex-col"},Ne={class:"flex-col p-8"},Fe=L({props:{id:null},setup(e){const t=e,a=oe(),o=t.id==="cloud-contract"?ie.fromPlaybook(se().load("db2a1d38-01fb-4ea2-bc6f-b5213413c809")):a.load(t.id),r=o.title||"Unbenannter Vertrag",n=I(r),d=I(r),u=I(!1),l=()=>{d.value=n.value,u.value=!0},p=()=>{u.value=!1,n.value=d.value,o.title=d.value},g=x=>{const f=x.target;f==null||f.select()},w=async()=>{await a.save(o)};return te(()=>{o.title||l()}),(x,f)=>{const _=Z("focus");return i(),B("div",Me,[v("nav",je,[c(ze,{modules:h(o).getModules(),onSave:w},null,8,["modules"])]),v("main",Ne,[c(h(q),{id:"dialog-contract-title",visible:u.value,"onUpdate:visible":f[1]||(f[1]=T=>u.value=T),modal:!0,"dismissable-mask":!0,header:"Wie wollen Sie den Vertrag benennen?"},{footer:k(()=>[c(h(K),{label:"OK",icon:"pi pi-check",onClick:p})]),default:k(()=>[D(c(h(N),{id:"input-contract-title",modelValue:d.value,"onUpdate:modelValue":f[0]||(f[0]=T=>d.value=T),title:"Titel des Vertrags",type:"text",onFocus:g,onKeyup:ne(p,["enter"])},null,8,["modelValue","onKeyup"]),[[_]])]),_:1},8,["visible"]),v("section",null,[c(h(K),{class:"p-button-link",onClick:l},{default:k(()=>[v("span",null,y(n.value),1)]),_:1})]),c(z,{name:"fade",mode:"out-in"},{default:k(()=>[c(he,{contract:h(o)},null,8,["contract"])]),_:1})])])}}});var Ye=j(Fe,[["__scopeId","data-v-5be13441"]]);const Ze=L({props:{id:null},setup(e){return(t,a)=>(i(),s(Ye,{id:e.id},null,8,["id"]))}});export{Ze as default};
